...
export const metadata: Metadata = {
  description:
    "Discover comprehensive range of categories and explore the latest posts across various topics. Stay up-to-date with the newest discussions, insights, and trends in our diverse community.  Find what interests you most and join the conversation.",
};
